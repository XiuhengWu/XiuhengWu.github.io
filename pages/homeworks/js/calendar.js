...
function CalendarControl() {
    ...
    const calendarControl = {
        ...
        displayMonth: function () {
          ...
          <mdui-button-icon icon="keyboard_arrow_left" class="calendar-prev"></mdui-button-icon>
          <div class="calendar-year-month">
          <div class="calendar-month-label"></div>
          <div>-</div>
          <div class="calendar-year-label"></div>
          </div>
          <mdui-button-icon icon="keyboard_arrow_right" class="calendar-next"></mdui-button-icon>
          </div>
          <mdui-button class="calendar-today-date">Today: 
            ${
...
plotDates: function () {
    ...
    for (let i = 1; i < calendarDays; i++) {
        if (i < calendarControl.firstDayNumber()) {
            ...
            document.querySelector(".calendar .calendar-body").innerHTML += `<div class="number-item" data-num=${count}><a class="dateNumber">${
                count++
            }</a></div>`;
        }
    }
