...
window.addEventListener("load", (event) => {
	...
	document.querySelector(`.navigation-rail .selection mdui-button[href="${
		location.hash
	}"]`).classList.add("select");
	document.querySelector(`.navigation-drawer mdui-list-item[href="${
		location.hash
	}"]`).classList.add("select");
	...
	document.querySelectorAll(".theme-button").forEach((button) => {
		if (config["theme"] != "auto") {
			button.icon = config["theme"] + "_mode";
		}
	...
	document.querySelectorAll("#navigation mdui-list-item").forEach((item) => item.addEventListener("click", function () {
		toggleDrawer("close");
	}));
	...
	document.querySelectorAll("#timeline .main li").forEach((card) => card.addEventListener("click", function () {
		location.href = this.getAttribute("data-target") + '?from=t';
	}));
